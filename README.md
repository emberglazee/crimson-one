...
- **`MarkovChain`**: A module to generate new messages based on text collected from server chat history. It can be trained on data from specific users, channels, or an entire server.
