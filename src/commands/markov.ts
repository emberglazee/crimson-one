...
import { ChannelType, SlashCommandBuilder, TextChannel, EmbedBuilder, Message, User } from 'discord.js'
...
async function _handleGenerateSubcommand(context: CommandContext, markov: MarkovChat, resolveUserOrId: (ctx: CommandContext) => ReturnType<typeof _resolveUserOrIdInternal>) {
...
async function _handleInfoSubcommand(context: CommandContext, markov: MarkovChat, resolveUserOrId: (ctx: CommandContext) => ReturnType<typeof _resolveUserOrIdInternal>) {
...
async function _handleCollectSubcommand(context: CommandContext, markov: MarkovChat, dataSource: DataSource, resolveUserOrId: (ctx: CommandContext) => ReturnType<typeof _resolveUserOrIdInternal>) {
    if (!context.guild) return
...
async function _handleCollectAllSubcommand(context: CommandContext, markov: MarkovChat, resolveUserOrId: (ctx: CommandContext) => ReturnType<typeof _resolveUserOrIdInternal>) {
    if (!context.guild) return
...
async function _resolveUserOrIdInternal(ctx: CommandContext): Promise<({ id: string } | User) | undefined> {
